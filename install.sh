...
default_version="v2026.8.2.post1"
...
usage() {
    cat <<HELP
Usage: bash install.sh [--version v2026.8.2.post1|latest] [--profile recommended|core] [--extras name[,name]]

Environment equivalents:
  AGENTOS_VERSION=v2026.8.2.post1
